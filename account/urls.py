...
urlpatterns = [
    ...
    path('<user_id>/review/<int:review_id>/edit/', views.review_edit, name='review_edit'),
    path('<user_id>/review/<int:review_id>/delete/', views.review_delete, name='review_delete'),
]