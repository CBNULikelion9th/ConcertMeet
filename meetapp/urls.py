...
urlpatterns = [
    ...
    path('lists/<int:post_id>/declaration/',
         views.post_declaration, name='post_declaration'),
    path('lists/<int:post_id>/comment/new/',
         views.comment_new, name='comment_new'),
    path('lists/<int:post_id>/comment/<int:id>/edit/',
         views.comment_edit, name='comment_edit'),
    path('lists/<int:post_id>/comment/<int:id>/delete/',
