...
class Participant(models.Model):
    created_user = models.ForeignKey('account.UserInfo', on_delete=models.CASCADE,)
    pcp_user = models.ManyToManyField('account.UserInfo', blank=True, related_name='pcp_user')  #공연 참가 유저수. 사용자가 존재하면 글 삭제 불가능. 유저 아이디 넣기
